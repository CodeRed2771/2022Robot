...
public class Shooter {
    ...
    private static shooterArrayValue[] shooterArray =  {
        ...
        new shooterArrayValue(ShooterPosition.Low, 2000),
        new shooterArrayValue(ShooterPosition.Low, 2500),
        new shooterArrayValue(ShooterPosition.Low, 3600),
        new shooterArrayValue(ShooterPosition.Low, 4800),
        new shooterArrayValue(ShooterPosition.Low, 5900),
    };
