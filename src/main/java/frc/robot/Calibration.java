...
public class Calibration {
    ...
    public final static double DT_NEW_A_ABS_ZERO_INITIAL = .562; // .684; // NEW BOT
    public final static double DT_NEW_B_ABS_ZERO_INITIAL = .298; //.983; 
    public final static double DT_NEW_C_ABS_ZERO_INITIAL = .330; //.040; 
    public final static double DT_NEW_D_ABS_ZERO_INITIAL = .321; // 276; 
